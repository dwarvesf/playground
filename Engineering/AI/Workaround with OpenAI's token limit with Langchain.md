...
![](assets/workaround-with-openai's-token-limit-with-langchain_openai-token-limit-prompts.png)
...
![](assets/workaround-with-openai's-token-limit-with-langchain_openai-token-limit.png)
...
![](assets/workaround-with-openai's-token-limit-with-langchain_openai-map-reduce.png)
...
![](assets/workaround-with-openai's-token-limit-with-langchain_openai-refining.png)
...
![](assets/workaround-with-openai's-token-limit-with-langchain_openai-map-rerank.png)
