...
Now let's look at the faces involved in Mapreduce. The phase where individuals collect the population of their assigned city or part of the city is called a [Map phase](https://brain.d.foundation/Engineering/Data/MapReduce+Components#Map+Phase).
