...
![](assets/hadoop-distributed-file-system-(hdfs)_file-size-vs-block-size.png)
...
![](assets/hadoop-distributed-file-system-(hdfs)_3-crashes.png)
...
![](assets/hadoop-distributed-file-system-(hdfs)_15-crashes.png)
...
![](assets/hadoop-distributed-file-system-(hdfs)_hadoop-nodes.png)
...
![](assets/hadoop-distributed-file-system-(hdfs)_copy-operation.png)
